...
import '../../models/settings_model.dart';
import 'dart:io';
import 'package:subliminal/main.dart' show startFlashTimer;
// import 'package:subliminal/services/flash_service.dart';
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Session starting...'),
                            backgroundColor: Color(0xFFB8D4D3),
                            duration: Duration(seconds: 1),
                          ),
                        );

                        await FlashService.startAndMinimize(_tempSettings);
                      },
