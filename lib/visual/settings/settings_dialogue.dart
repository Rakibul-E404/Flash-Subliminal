...
class _FlashOverlayWidgetState extends State<FlashOverlayWidget> {
  ...
  //
  //   // Always render the scaffold so the isolate stays alive.
  //   // Only show the image layer when _showImage is true.
  //   return Material(
  //     color: Colors.transparent,
  //     child: Stack(
  //       children: [
  //         // ── Dim backdrop (only when image is showing) ──
  //         if (_showImage)
